<?php
/**
 * cpanel - /usr/local/cpanel/php/cpanel.php      Copyright(c) 2012 cPanel, Inc.
 *                                                          All rights Reserved.
 ...
 * For the full documentation please see http://docs.cpanel.net/twiki/bin/view/AllDocumentation/AutomationIntegration/LivePHP
 *
 ...
 *     will likely throw E_USER_DEPRECATED; Locale::maketext() API1 should be
 *     used instead
 *
 *  Version 2.0
 ...
 * @copyright 1997-2012 cPanel, Inc.
 * @license   http://cpanel.net
 * @version   Release: 2.1
 * @link      http://docs.cpanel.net/twiki/bin/view/SoftwareDevelopmentKit/LivePHP
 */
class CPANEL
{
    /**
     ...
     *
     * @link http://docs.cpanel.net/twiki/bin/view/DeveloperResources/ExpVarRef ExpVar Reference Chart
     ...
     * Locale::maketext
     * @see http://docs.cpanel.net/twiki/bin/vief/SoftwareDevelopmentKit/MakeText#API1
     *
    ...
    public function exec($code, $skip_return = 0)
    {
        ...
        if ($json_start_pos !== false) {
            ...
            $this->_result = XML_unserialize(trim($result));
        }
        return $this->_result;
    }
    /**
    ...
    public function api($reqtype, $version, $module, $func, $args = array())
    {
        ...
        if (function_exists('json_encode')) {
            ...
            */
            ...
            include_once '/usr/local/cpanel/php/xml.php';
            $code = XML_serialize(array("cpanelaction" => array($input)));
        }
